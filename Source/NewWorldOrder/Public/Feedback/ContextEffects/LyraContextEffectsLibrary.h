...
DECLARE_DYNAMIC_DELEGATE_OneParam(
	FLyraContextEffectLibraryLoadingComplete,
	TArray<ULyraActiveContextEffects*>,
	LyraActiveContextEffects);

/**
 * EffectTag + ContextTag 到声音/Niagara 的数据驱动映射。
 * 运行时类不硬编码具体脚步资产；资源由蓝图组件配置的 Library 决定。
 */
...
private:
	...
	void LyraContextEffectLibraryLoadingComplete(TArray<ULyraActiveContextEffects*> LoadedContextEffects);
