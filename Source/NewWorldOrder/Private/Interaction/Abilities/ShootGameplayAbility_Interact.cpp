...
UShootGameplayAbility_Interact::UShootGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
{
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UShootGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UShootGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	CurrentOptions = InteractiveOptions;
}

void UShootGameplayAbility_Interact::TriggerInteraction()
{
