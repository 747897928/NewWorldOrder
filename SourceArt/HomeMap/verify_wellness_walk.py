...
def wellness_tick(dt):
    ...
    if result['reached']==len(targets) or now>50:
        ...
        (ROOT/'Docs/Tasks/HomeMap/Reports/wellness_walk.json').write_text(json.dumps(result,indent=2),encoding='utf-8');unreal.unregister_slate_post_tick_callback(wellness_handle);return
