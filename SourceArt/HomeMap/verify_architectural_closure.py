"""从室外穿过常开大门，经客厅、楼梯、Gallery 到直线跳台；仅起点归位。"""
...
targets=[[0,-800],[0,-320],[180,100],[360,170],[360,-745],[-450,-730],[-450,90],[-280,90],[-280,835]]
...
def terrace_tick(dt):
    ...
    if result['saw_swimming'] or now>100:
        ...
        (ROOT/'Docs/Tasks/HomeMap/Reports/architectural_closure_walk.json').write_text(json.dumps(result,indent=2),encoding='utf-8')
...
print('ENTRY_STAIRS_GALLERY_DIVE_TEST_STARTED')
