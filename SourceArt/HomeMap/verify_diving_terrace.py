"""只注入既有角色的移动和跳跃输入，验收楼梯到跳台及现有游泳衔接。"""
...
pawn.set_actor_location(unreal.Vector(360,170,90),False,False)
targets=[[360,-745],[-450,-730],[-450,90],[-280,90],[-280,835]]
...
def terrace_tick(dt):
    ...
    if result['saw_swimming'] or now>80:
        ...
        (ROOT/'Docs/Tasks/HomeMap/Reports/diving_terrace_walk.json').write_text(json.dumps(result,indent=2),encoding='utf-8')
...
print('DIVING_TERRACE_TEST_STARTED')
