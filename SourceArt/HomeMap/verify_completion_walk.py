...
movement.stop_movement_immediately();pawn.set_actor_location(unreal.Vector(750,-650,90),False,False)
targets=[[1190,-650],[1250,-450],[1220,-300],[800,-300],[800,-100],[570,100],[570,1400],[760,1460],[800,1740],[940,1740],[1250,1840],[1250,1620],[940,1740],[760,2000]]
...
def closure_tick(dt):
    ...
    if closure_result['reached']==len(targets) or now>90:
        ...
        (ROOT/'Docs/Tasks/HomeMap/Reports/completion_walk.json').write_text(json.dumps(closure_result,indent=2),encoding='utf-8');unreal.unregister_slate_post_tick_callback(closure_handle);return
