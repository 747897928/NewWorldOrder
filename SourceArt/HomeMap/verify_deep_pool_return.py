...
targets=[[0,1300,-280],[0,1000,-65],[0,220,90]]
...
def deep_return_tick(dt):
    ...
    if pool_result['reached']==len(targets) or now>60:
        ...
        (ROOT/'Docs/Tasks/HomeMap/Reports/deep_pool_return.json').write_text(json.dumps(pool_result,indent=2),encoding='utf-8');unreal.unregister_slate_post_tick_callback(deep_return_handle);return
